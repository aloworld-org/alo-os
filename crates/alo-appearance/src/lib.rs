...
//! ```
//! use alo_appearance::{
//!     Appearance, Background, DisplayId, Following, Scheme, Shipped, TextScale, TimeOfDay,
//! };
//!
...
//!
//! **The accent colour**, which `docs/features.md` names at v0.5 and item 8a in
//! `docs/autonomy/QUEUE.md` holds. The design brief spends terracotta in one
//! place only — where the agent is present or acting — and the five other
//! colours here are structure and grounds rather than accents: navy is
//! unreadable against the charcoal rail, cream against the cream ground. So
//! *an accent drawn from the design tokens* has no answer among these six, and
//! inventing colours is a designer's decision rather than this loop's.
//!
