...
//! what stops each file inventing a vocabulary that resembles the real one. The
//! real one is [`crate::dock_words`], and it is what both of these are built
//! from.
//!
...
///
/// German because it is the language `alo-appearance`'s notes were written
/// against and because it puts a space before a percent sign where English does
/// not — which is the one thing a translator decides about this crate's
/// numbered strings.
