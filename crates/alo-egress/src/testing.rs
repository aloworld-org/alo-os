...
//! what stops four files inventing four vocabularies that resemble the real
//! one. The real one is [`crate::egress_words`], and both of these are built
//! from it.
//!
...
pub(crate) fn in_english() -> Strings {
    Strings::of(egress_words().unwrap())
}
