...
//! what stops eight files inventing eight vocabularies that resemble the real
//! one. The real one is [`crate::shortcut_words`], and it is what both of these
//! are built from.
//!
...
use crate::words::{Word, shortcut_words};
...
///
/// German because it is the language whose keyboard prints something different
/// on half the keys this crate names — *Entf*, *Einfg*, *Pos1*, *Strg* — so a
/// test written in it is a test of the thing the notes in [`crate::words`] are
/// about, rather than of a language chosen for being easy to type.
