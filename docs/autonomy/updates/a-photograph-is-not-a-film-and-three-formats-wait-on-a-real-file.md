...
- **Task 7 was written**, because the plan named none after 6 and a plan that
  ...
  wait on documents from the owner, for ADR 0057's reason: a `.doc` saved by
...
- **Task 6 itself.** Blocked on ADR 0057 and, if it is accepted as recommended,
...
- `docs/autonomy/QUEUE.md`: task 6 of the documents-and-paper plan moves from
  ready to **blocked on ADR 0057**; a new task 7 (*an OpenDocument text,
...
- `ROADMAP.md`: no line moves. The ★ *"I can't open this file"* line stays
  unmet for the three formats it names, and ADR 0057 is where that is now
  written down rather than discovered.
- `docs/decisions/`: ADR 0057 is **proposed** and needs the owner's answer.
