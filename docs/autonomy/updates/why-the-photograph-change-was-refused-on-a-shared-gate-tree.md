...
The first worker marked task 6 **blocked** on ADR 0056 rather than **Done**, and
...
owner answers ADR 0056 and the files arrive. Marking it done would be claiming
...
plan is blocked on ADR 0056 awaiting the owner's answer, and task 7 is ready.
