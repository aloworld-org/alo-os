...
**Verify first, and write nothing if it fails.** Release `0.0.4` was signed by
...
`cosign` installed:
    ...
    cosign verify --key image/signing/alo-os.pub --insecure-ignore-tlog=true \
      ghcr.io/aloworld-org/alo-os@sha256:48bd5f319abcecfa832eb9a5b0b2f7cd06815b1c30c43b781499500ec14c3858
...
changed:
    ...
    podman pull ghcr.io/aloworld-org/alo-os@sha256:48bd5f319abcecfa832eb9a5b0b2f7cd06815b1c30c43b781499500ec14c3858
